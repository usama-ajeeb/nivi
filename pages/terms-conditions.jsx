  ...
  return (
    <div>
      ...
      <div className='relative h-[300px]'>
        <Image src='/images/terms.png' layout='fill' objectFit='cover' />
      </div>

      {/* Body */}

      <div className='flex  flex-col gap-y-3 items-start max-w-[1146px] ml-auto mr-auto mt-14'>
        <h1 className='text-2xl font-bold'>Terms and Conditions</h1>
        <p>Welcome to www.nivics.com!</p>
        <p>
          These terms and conditions outline the rules and regulations for the
          use of Nivi Consultancy Services ‘s Website, located at
          www.nivics.com.
        </p>
        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use www.nivics.com if you do not agree
        ...
        <p>
          We employ the use of cookies. By accessing www.nivics.com, you agreed
          to use cookies in agreement with the Nivi Consultancy Services ‘s
          Privacy Policy.
        </p>
        <p>
        ...
        <p>
          Unless otherwise stated, Nivi Consultancy Services and/or its
          licensors own the intellectual property rights for all material on
          www.nivics.com. All intellectual property rights are reserved. You may
          access this from www.nivics.com for your own personal use subjected to
          restrictions set in these terms and conditions.
        </p>
        <ul className=' list-disc'>
          <p>You must not:</p>
          <li>Republish material from www.nivics.com</li>
          <li>Sell, rent or sub-license material from www.nivics.com</li>
          <li>Reproduce, duplicate or copy material from www.nivics.com</li>
          <li>Redistribute content from www.nivics.com</li>
        </ul>
        <p>
        ...
        <p>
          ...
          Nivi Consultancy Services does not filter, edit, publish or review
          Comments prior to their presence on the website. Comments do not
          reflect the views and opinions of Nivi Consultancy Services ,its
          ...
          by applicable laws, Nivi Consultancy Services shall not be liable for
        ...
        Nivi Consultancy Services reserves the right to monitor all Comments and
        ...
        <ul className=' list-disc'>
          ...
          <p>
            You hereby grant Nivi Consultancy Services a non-exclusive license
        ...
        <p>
          ...
          the hyperlink compensates the absence of Nivi Consultancy Services ;
        ...
        <ul className=' list-disc'>
          ...
          <p>
            No use of Nivi Consultancy Services ‘s logo or other artwork will be
